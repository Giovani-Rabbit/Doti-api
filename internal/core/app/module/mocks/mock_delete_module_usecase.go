...
// Source: internal/core/app/module/delete_module_usecase.go
...
func (m *MockDelete) Execute(ctx context.Context, id string) error {
	m.ctrl.T.Helper()
...
func (mr *MockDeleteMockRecorder) Execute(ctx, id interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Execute", reflect.TypeOf((*MockDelete)(nil).Execute), ctx, id)
}
